...
const AllCourses = () => {
    ...
    const handleEdit = (course: any) => {
        ...
        router.push(`/admin/courses/managecourses?course_id=${course?.course_id}`);
    };
    ...
    const CourseCard = ({ course }) => (
        <div className="group relative overflow-hidden rounded-lg bg-white shadow-md transition-transform duration-300 hover:scale-105 dark:bg-gray-800">
            <img className="h-48 w-full object-cover" src={`${process.env.ADMINURL}/uploads/course_thumbnail/${course.course_thumbnail}`} alt="Course Thumbnail" />
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                <div className="flex items-center justify-center text-white">
                    <div className="mr-4 rounded-md bg-slate-900 p-2 shadow-lg cursor-pointer" onClick={() => handleEdit(course)}>
