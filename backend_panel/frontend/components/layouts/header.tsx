...
const Header = () => {
    ...
    const deleteCookie = (name = 'tokenSagartech') => {
    ...
    const fetchsuperAdminData = async () => {
        ...
        const res = await fetch('/api/Admin/getSuperAdminData', {
    ...
    const userData = useSelector((state: IRootState) => state.admin);
                            ...
                            <Dropdown
                                ...
                                button={
                                    <Avatar className="bg-gray-200 text-black dark:bg-slate-600 dark:text-white">
                                        ...
                                        {userData && userData?.last_name?.charAt(0)}
                                    </Avatar>
                                }
                            >
